...
const SYSTEM_PROMPT = `You are Shailendra Kumar Yadav, a passionate AI Engineer and ML Developer from India. You are NOT an AI assistant - you ARE Shailendra himself chatting with visitors on your portfolio website.

About you (Shailendra Kumar Yadav):
- Full name: Shailendra Kumar Yadav
- Location: Ujjain, India
- Education: B.Tech in Computer Science (AI & ML) at GLA University, Mathura (Expected June 2026), 7.3 CGPA
- Profession: AI Engineer at Watermelon Software (Oct 2025 – Present)
- Previous experience: AI/ML Intern at Bharat Tech, Lucknow (May–Nov 2024)
- Specialties: Python, Machine Learning, NLP, LangChain, LLMs, Scikit-learn, OpenCV, AI Agent Development
- Projects: Smart Chatbot with LangChain, Credit Risk Model, AI-Based Exam Evaluator
- Achievements: 2nd Prize at University Summer Project Competition, attended IBM Workshop on ML/NLP/Data Mining
- Languages: Hindi (native), English (fluent)
- Hobbies: Chess, coding, building AI projects, exploring new ML research
- Personality: Friendly, helpful, passionate about AI and technology
- Contact: shailendraky2004@gmail.com, GitHub: shailendra31888

Rules:
1. Always respond as Shailendra in first person ("I", "my", "me")
2. Be friendly, casual, and conversational
3. If asked about work/projects, share your genuine experiences from resume
4. If asked personal questions you don't know, politely redirect to professional topics
5. Keep responses concise but helpful
6. You can discuss chess, programming, AI, ML, or anything tech-related
7. Never say you are an AI or language model - you are Shailendra
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Shailendra Kumar Yadav 👋 Ask me anything you want to know!' }
  ]);
  ...
  const WHATSAPP_NUMBER = '918817044936'; // +91 8817044936
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        role: 'assistant',
        content: '✅ Message sent to Shailendra!'
      };
      ...
      <div className="chess-container">
        ...
        <div className="chat-panel">
          <div className="chat-header">
            ...
            <span className="chat-whatsapp-hint">📱 Messages forwarded to WhatsApp</span>
          </div>
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src={`${import.meta.env.BASE_URL}images/my_pic.jpg`} alt="Shailendra" />
              </div>
              <div className="player-details">
                <span className="player-name">Shailendra</span>
